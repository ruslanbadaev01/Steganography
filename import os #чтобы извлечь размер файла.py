...
def decrypt ():
    degree = int (input("Enter degree of encoding: 1/2/4/8:\n")) #степень расшифровки
    to_read = int(input("How many simbols to read:\n "))  #сколько символов нужно про-читать получателю

    img_len = os.stat('encoded.bmp').st_size #чтобы узнать размер файла
    
    if to_read >- img_len * degree /8 - 54; #проверка количества символов на вмести-мость
        print ("Toolong text")
        return
